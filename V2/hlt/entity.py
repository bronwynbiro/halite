...
class Entity:
    ...
    def closest_point_to(self, target, min_distance=1.5):
        """
...
class Planet(Entity):
    ...
    def get_docked_ship(self, ship_id):
        ...
        :return: The S
        Ship object representing that id or None if not docked.
        :rtype: Ship
        """
...
class Ship(Entity):
    ...
    def navigate(self, target, game_map, speed, avoid_obstacles=True, max_corrections=45, angular_step=2,
